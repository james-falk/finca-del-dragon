...
const Signin = () => {
  ...
  return (
    <>
      ...
      <span className='z-1 relative my-8 block text-center  before:absolute before:h-px before:w-40% before:bg-black before:left-0 before:top-3  after:absolute after:h-px after:w-40% after:bg-black/60 after:top-3 after:right-0'>
      ...
      <form onSubmit={(e) => e.preventDefault()}>
        ...
        <div className='mb-9'>
          <button
            onClick={loginUser}
            type='submit'
            className='bg-primary w-full py-3 rounded-lg text-base text-white font-medium border border-primary hover:text-primary hover:bg-transparent'>
