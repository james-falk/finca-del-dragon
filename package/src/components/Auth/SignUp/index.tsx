      ...
      <form onSubmit={handleSubmit}>
        <div className='mb-[22px]'>
          <input
            ...
            name='name'
            required
            className='w-full rounded-md border border-black/30 border-solid bg-transparent px-5 py-3 text-base text-dark outline-hidden transition placeholder:text-white/30 focus:border-primary focus-visible:shadow-none text-white dark:focus:border-primary'
          />
        </div>
        <div className='mb-[22px]'>
          <input
